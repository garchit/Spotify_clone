...
function playAll(songNumber){
    ...
    if(audioElement.getAttribute("src")==songFileName && !audioElement.paused){
        ...
        if (songNumber === 1) {
            ...
            bannerImage.setAttribute("src", "images/img2.png");
            ...
            bannerImage.setAttribute("src", "./images/img10.png");
